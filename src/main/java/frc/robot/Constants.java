...
public final class Constants {
  ...
  public static final class SuperStructureSetpoints {
    ...
    public static final double elevatorScoreConeMid = -0.25; // Meters
    public static final double armScoreConeMid = 0;

    public static final double elevatorScoreConeHigh = -.5; // Meters
  ...
  public static final class ElevatorConstants {
    ...
    public static final double elevatorMaxVel = 1; // Meters per second
